...
public class MainJFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        loginJButton.setFont(new java.awt.Font("Calibri", 1, 18)); // NOI18N
        ...
        logoutJButton.setFont(new java.awt.Font("Calibri", 1, 18)); // NOI18N
        ...
        signUpJButton.setFont(new java.awt.Font("Calibri", 1, 18)); // NOI18N
        signUpJButton.setText("Sign Up");
        signUpJButton.setOpaque(false);
    ...
    private void loginJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginJButtonActionPerformed
        ...
        if (userAccount == null) {
            userAccount = system.getPersonOrg().getUserAccountDirectory().authenticateUser(userName, password);
            if (userAccount != null) {
              //  break;
                ...
                for (Country country : system.getCountryList().getCountryDirectory()) {
                    ...
                    if (userAccount != null) {
                        ...
                        for (State state : country.getStateList().getStateDirectory()) {
                            ...
                            if (userAccount != null) {
                               ...
                               // System.out.println("Enterprise loop begin");
                                ...
                                for (Enterprise enterprise : state.getEnterpriseDirectory().getEnterpriseList()) {
                                    ...
                                    if (userAccount != null) {
                                      ...
                                      //  System.out.println("Enterprise assigned " + inEnterprise);
                                        break;
                                    } else {
                                      //  System.out.println("Organization loop begin");
                                        ...
                                        for (Organization organization : enterprise.getOrganizationDirectory().getOrganizationList()) {
                                            ...
                                            if (userAccount != null) {
                                                ...
                                                inEnterprise = enterprise;
//                                                System.out.println("Organization assigned " + inOrganization);
...
//                 
                    ...
                    //break country loop
                    if (inState != null || inEnterprise != null || inOrganization != null) {
                       // System.out.println("break country loop");
                        break;
                    }
        ...
        loginJButton.setEnabled(
                false);
        logoutJButton.setEnabled(
                true);
        userNameJTextField.setEnabled(
                false);
    ...
    private void signUpJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_signUpJButtonActionPerformed
        ...
        SignUpJPanel sujp = new SignUpJPanel(container, system);
        container.add(sujp);
        CardLayout layout = (CardLayout) container.getLayout();
        layout.next(container);
